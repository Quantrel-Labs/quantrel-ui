...
export default function SellerSettings() {
  const [formData, setFormData] = useState({
    ...
    storeName: "My Store",
    storeDescription: "Quality AI tools and agents"
  })
          ...
          <div className="p-8 rounded-2xl bg-white/[0.02] border border-white/10">
            ...
            <div className="space-y-4">
              {[
                ...
                { key: "salesAlerts", label: "Sales Alerts", description: "Get notified when you make a sale" },
          ...
          <div className="p-8 rounded-2xl bg-red-500/5 border border-red-500/20">
            ...
            <div className="space-y-4">
              <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-1">Delete Store & Account</h3>
                    <p className="text-sm text-gray-400">Permanently delete your store, account and all data</p>
                  </div>
                  <Button
                    variant="outline"
