            ...
            {step === "email" ? (
              ...
              >
                  ...
                  <p className="text-xs text-white/40 pt-10">
                    New to Quantrel?{' '}
                    <Link to="/register" className="underline text-white/60 hover:text-white transition-colors">
                      Create an account
                    </Link>
                  </p>
                </div>
                ...
                >
                  ...
                  <div className="pt-4">
                    <Link to="/forgot-password" className="text-white/50 hover:text-white/70 transition-colors text-sm">
                      Forgot password?
                    </Link>
                  </div>
                </div>
